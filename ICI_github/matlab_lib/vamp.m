function xest = vamp(y,var,Phi,lambda,BG_var,niter)
...
%         break
%     end
    [x_pos,x_var_pos] = LMMSE_module(y,Phi,Cw,x_pir,x_var_pir);
%     x_var_pos
    
    [x_ext,x_var_ext] = Gauss_pos_to_ext(x_pos,x_var_pos,x_pir,x_var_pir);
...
%     [x_BG_pos,x_BG_var_tmp,x_BG_nzp,x_BG_var] = vamp_BG_Gauss(BG_mu,BG_var,x_ext,x_var_ext,lambda);
    ...
    [x_pir,x_var_pir] = Gauss_pos_to_ext(x_BG_pos,x_BG_var,x_ext,x_var_ext);
...
function [mu_pos,var_pos] = LMMSE_module(y,phi,Cw,x_pir,x_var_pir)
