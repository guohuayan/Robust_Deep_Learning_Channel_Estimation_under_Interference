...
if __name__ == '__main__':
    ...
    for i, test_snr in enumerate(snr_w):
        ...
        Ht_vbi=Add_noise_hdelay(H_test,test_snr,Fm)
        ...
        mse_est=torch.float_power(torch.tensor(10), test_snr/torch.tensor(-10))
    ...
    savemat("./ICI_github/major_ici_free_60k_cnn_off_novbi.mat", mdic)
